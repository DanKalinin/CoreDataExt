...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   CoreDataExt.framework
                   DESC

  s.homepage     = "https://github.com/DanKalinin/CoreDataExt"
  ...
  s.source       = { :git => "https://github.com/DanKalinin/CoreDataExt.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "CoreDataExt/**/*.{h,m}"
  s.exclude_files = "CoreDataExt/**/Info.plist"
  ...
  # s.resource  = "icon.png"
  s.resources = "CoreDataExt/**/*.{json,plist}"
